...
public sealed partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        _profiles = ServiceLocator.Profiles;
    ...
    private void ShowOrRevealWidget()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.ShowOrRevealWidget", $"ignored: {ex.Message}");
        }
    }
    ...
    private void ConfigureBorderlessWidgetChrome()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.ConfigureBorderlessWidgetChrome", $"ignored presenter: {ex.Message}");
        }
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.ConfigureBorderlessWidgetChrome", $"ignored DWM: {ex.Message}");
        }
    ...
    private void OnWindowClosed(object sender, WindowEventArgs args)
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.OnWindowClosed", $"ignored: {ex.Message}");
        }
    ...
    private void SubscribeToMoveResize()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.SubscribeToMoveResize", $"ignored: {ex.Message}");
        }
    }
    ...
    private void RefreshDockRevealIndicatorFromWindowGeometry()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.RefreshDockRevealIndicatorFromWindowGeometry", $"ignored: {ex.Message}");
        }
    }
    ...
    private double WindowContentWidthForChips()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.WindowContentWidthForChips", $"ignored: {ex.Message}");
            return 0;
        }
    }
    ...
    private double WindowContentHeightForChips()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.WindowContentHeightForChips", $"ignored: {ex.Message}");
            return 0;
        }
    }
    ...
    private (int Width, int Height) ComputeClientSizeForPreset(WidgetSizePreset preset, int columns, int rows)
    {
        ...
        else
        {
            ...
            {
                CrashLog.WriteDiagnostic("MainWindow.ComputeClientSizeForPreset", $"ignored: {ex.Message}");
                height = Math.Max(gridSize.Height, GetMinClientHeight());
            }
        }
    ...
    private double RasterizationScale()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.RasterizationScale", $"ignored: {ex.Message}");
        }
    ...
    private void MaybeResizeUndockedFromGumball(bool force = false)
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.MaybeResizeUndockedFromGumball", $"ignored: {ex.Message}");
        }
    }
    ...
    private void ApplyMinimumWindowSize()
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.ApplyMinimumWindowSize", $"ignored: {ex.Message}");
        }
    }
    ...
    private static string TryDevTitleSuffix(string baseTitle)
    {
        ...
        {
            CrashLog.WriteDiagnostic("MainWindow.TryDevTitleSuffix", $"ignored: {ex.Message}");
            return baseTitle;
        }
    }
}
